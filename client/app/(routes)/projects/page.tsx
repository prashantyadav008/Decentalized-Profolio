...
export default function ProjectsPage() {
  ...
  const [activeGithubProjectFilter, setActiveGithubProjectFilter] = useState<
    string | null
  >(null);
    ...
    <section className="py-12 md:py-24">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <motion.div
          ...
          <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            A showcase of my work across various technologies used in my Github
            Projects
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          <div className="flex flex-wrap gap-2 justify-center mb-8">
            <Badge
              variant={
                activeGithubProjectFilter === null ? "default" : "outline"
              }
              className="cursor-pointer text-sm py-2 px-3"
              onClick={() => setActiveGithubProjectFilter(null)}>
              All
            </Badge>
            {allGithubProjectTechnologies.map((tech) => (
              <Badge
                key={tech}
                variant={
                  activeGithubProjectFilter === tech ? "default" : "outline"
                }
                className="cursor-pointer text-sm py-2 px-3"
                onClick={() => setActiveGithubProjectFilter(tech)}>
                {tech}
              </Badge>
            ))}
          </div>
