      ...
      <motion.div
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">Prashant Yadav</h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              Passionate Blockchain Developer with experience in EVM-based
              chains, Hyperledger Fabric, and production-grade dApps.
            </p>
          </div>
        ...
        <motion.div
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center text-sm text-muted-foreground">
              ...
              <span>
                {new Date().getFullYear()} Prashant Yadav. All rights reserved.
              </span>
            </div>
